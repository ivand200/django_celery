...
SECRET_KEY = "django-insecure-1(b!woqt&x-so0&8t5i9@xwg&4dp&=p^b9+lj8!f64k0=8$640"
...
CELERY_BROKER_URL = os.environ.get("CELERY_BROKER", "redis://redis:6379/0")  # redis://redis:6379/0  redis://127.0.0.1:6379/0
